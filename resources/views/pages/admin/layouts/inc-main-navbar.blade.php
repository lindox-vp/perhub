<div class="navbar navbar-light navbar-lg navbar-expand-md content-boxed">
    <div class="brand wmin-250">
        <a href="{{ route('a.dashboard') }}" class="d-flex text-dark mt-1">
            <img src="{{ asset('assets/img/logo-dishub.png') }}" class="op-0-8" height="36">
            <div class="ml-2">
                <span class="brand-title-sm">KEMENTRIAN PERHUBUNGAN</span>
                <div class="brand-title-lg">PANELADMINISTRATOR</div>
            </div>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        ...
        <span class="navbar-text ml-md-auto mr-md-3">
            <span class="badge bg-success-400 shadow-1">ONLINE</span>
        </span>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="{{ asset('assets/limitless-assets/global/images/placeholders/placeholder.jpg') }}" class="rounded-circle" alt="">
                    <span>Victoria</span>
                </a>
